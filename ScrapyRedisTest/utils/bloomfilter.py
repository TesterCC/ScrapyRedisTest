...
# -*- coding:utf-8 -*-
__author__ = 'MFC'
__time__ = '18/4/5 22:36'

"""
http://www.cnblogs.com/heaad/archive/2011/01/02/1924195.html
pip install mmh3 -i https://pypi.douban.com/simple/
"""
...
if __name__ == '__main__':
    ...
    print(bf.is_exist('www.zhihu.com'))   # 1 exist
    print(bf.is_exist('www.lagou.com'))   # 2 don't exist

    delta = end - start
    print("Delta time is: {}".format(delta))